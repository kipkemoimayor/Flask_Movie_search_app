...
def index():
    message="hello world"
    css="main.css"
    title="Welcome to the best movie website out there"
    ...
    if(search_movie):
        ...
        return render_template('index.html',message=message,css=css,title=title,popular=popular_movies,upcoming=upcoming_movies,now_playing=now_showing)
